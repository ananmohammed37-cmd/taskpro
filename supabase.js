...
const SUPABASE_ANON_KEY = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Inp6end0b2ZlZnl2cXl6eG5oeWRjIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NzI3MDQzNTAsImV4cCI6MjA4ODI4MDM1MH0.Syj-Nw6P4ZKIt1q5Xqb-ML9UurYcCFzpDvqo5uwJMHY'

export const supabase = createClient(SUPABASE_URL, SUPABASE_ANON_KEY, {
  auth: {
    persistSession: true,
    storageKey: 'taskpro-auth',
